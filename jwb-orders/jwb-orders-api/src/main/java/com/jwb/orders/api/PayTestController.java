...
//        alipayRequest.setReturnUrl("http://domain.com/CallBack/return_url.jsp");
        alipayRequest.setNotifyUrl("https://300df58d.r8.cpolar.top/orders/paynotify");//在公共参数中设置回跳和通知地址
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(qrCodeUtil.createQRCode("http://192.168.1.104:63030/orders/alipaytest", 200, 200));
